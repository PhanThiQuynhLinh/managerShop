            ...
            <div class="content">
                <div class="content-top">
                    ...
                    <div class="content-top-in">
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html">
                                	<img    src='<c:url value = "/resources/common/images/pi.jpg" />'alt="" /></a>	
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img    src='<c:url value = "/resources/common/images/pi1.jpg"/>' alt="" />	</a>
                                <div class="top-content">
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img    src='<c:url value = "/resources/common/images/pi2.jpg"/>' alt="" /></a>	
                                <div class="top-content">
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img    src='<c:url value = "/resources/common/images/pi3.jpg"/>' alt="" /></a>	
                                <div class="top-content">
                ...
                <div class="content-top">
                    ...
                    <div class="content-top-in">
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img    src='<c:url value = "/resources/common/images/pi.jpg"/>' alt="" /></a>	
                                <div class="top-content">
                                    <h5><a href="single.html">Mascot Kitty - White</a></h5>
                                    <div class="white">
                                        <a href="single.html" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">ADD TO CART</a>
