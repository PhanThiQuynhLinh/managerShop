<%-- 
    ...
    Created on : 24-Nov-2018, 10:56:47 AM
    Author     : TVD
--%>
...
<html>
    ...
    <body>
        ...
        <div class="footer">
            ...
            <div class="footer-middle">
                <div class="container">
                    <div class="footer-middle-in">
                        <h6>About us</h6>
                        <p>Suspendisse sed accumsan risus. Curabitur rhoncus, elit vel tincidunt elementum...</p>
                    </div>
                    <div class="footer-middle-in">
                        <h6>Information</h6>
                        <ul>
            ...
            <p class="footer-class">Copyright © 2018. Design by  <a href="https://teamvietdev.com/" target="_blank">Team Viet Dev</a> </p>
